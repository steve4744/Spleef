...
public class ShopFiles {
	...
	public ShopFiles(Spleef plugin) {
		this.plugin = plugin;
	}
	...
	public void setShopItems() {
		...
		cfg.addDefault("1.permission", "spleef.shop.1");
		...
		cfg.addDefault("2.permission", "spleef.shop.2");
		...
		cfg.addDefault("3.permission", "spleef.shop.3");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("4.permission", "spleef.shop.4");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("5.permission", "spleef.shop.5");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("6.permission", "spleef.shop.6");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("7.permission", "spleef.shop.7");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("8.permission", "spleef.shop.8");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("9.permission", "spleef.shop.9");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("10.permission", "spleef.shop.10");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("11.permission", "spleef.shop.11");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("12.permission", "spleef.shop.12");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("13.permission", "spleef.shop.13");
		lore = new ArrayList<String>();

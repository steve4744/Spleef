...
public class Bars {
	...
	private static BarColor getBarColor() {
		int index = 0;
		String col = Spleef.getInstance().getConfig().getString("special.BossBarColor");
	...
	public static void setBar(Arena arena, String message, int count, int seconds, double progress, Spleef plugin) {
	...
	public static void loadBars(Spleef plugin) {
